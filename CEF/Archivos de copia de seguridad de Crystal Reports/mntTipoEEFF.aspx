<%@ Page Language="vb" AutoEventWireup="false" Codebehind="mntTipoEEFF.aspx.vb" Inherits="CEF.WebUI.mntTipoEEFF"%>
	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			...
			<TABLE cellSpacing="0" cellPadding="0" width="530" border="0">
				<TR>
					<TD vAlign="top" align="left" width="510">
													...
													<TABLE height="29" cellSpacing="0" cellPadding="0" width="100%" border="0">
														<TR>
															<TD class="lightbluebg" style="PADDING-RIGHT: 5px; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; HEIGHT: 29px"
																noWrap><SPAN class="SearchResultsHeader">Tipo de EEFF</SPAN></TD>
															<TD width="99%">&nbsp;</TD>
														...
														<TR>
															<TD class="Marco" vAlign="top" width="490" colSpan="4">
																<DIV class="Grid" id="divComercialProp" style="WIDTH: 490px; HEIGHT: 340px"><asp:datagrid id="dgrdMnt" runat="server" Width="480px" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False"
																		AllowPaging="True" UseAccessibleHeader="True" scope="col" BorderColor="#3366CC" BorderStyle="None">
																		...
																		<Columns>
																			...
																			<asp:TemplateColumn HeaderText="Orden">
																				...
																				<EditItemTemplate>
																					...
																					<asp:RequiredFieldValidator id="vreqOrden" runat="server" Width="2px" Display="Dynamic" ControlToValidate="txtOrden"
																						ErrorMessage="Ingrese el orden de prioridad">*</asp:RequiredFieldValidator>
																				</EditItemTemplate>
																			</asp:TemplateColumn>
