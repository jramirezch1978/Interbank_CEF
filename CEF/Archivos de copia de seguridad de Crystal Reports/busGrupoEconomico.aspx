<%@ Page Language="vb" AutoEventWireup="false" Codebehind="busGrupoEconomico.aspx.vb" Inherits="CEF.WebUI.busGrupoEconomico"%>
										...
										<TR>
											<TD class="Marco" vAlign="top" width="440" colSpan="4">
												<DIV class="Grid" id="divComercialProp" style="WIDTH: 440px; HEIGHT: 310px"><asp:datagrid id="dgrdMnt" runat="server" Width="430px" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False"
														AllowPaging="True" UseAccessibleHeader="True" scope="col" CssClass="GridMnt" BorderColor="#3366CC" BorderStyle="None">
