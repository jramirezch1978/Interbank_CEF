...
Public Class EEFF_Sub_FuentesyUsosdeFondos
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "EEFF_Sub_FuentesyUsosdeFondos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEEFF_Sub_FuentesyUsosdeFondos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EEFF_Sub_FuentesyUsosdeFondos = New EEFF_Sub_FuentesyUsosdeFondos
        rpt.Site = Me.Site
        Return rpt
    End Function
