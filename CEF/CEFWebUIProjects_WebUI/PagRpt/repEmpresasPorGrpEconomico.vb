...
Public Class repEmpresasPorGrpEconomico
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "repEmpresasPorGrpEconomico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrepEmpresasPorGrpEconomico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As repEmpresasPorGrpEconomico = New repEmpresasPorGrpEconomico()
        rpt.Site = Me.Site
        Return rpt
    End Function
