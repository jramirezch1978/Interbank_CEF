...
Namespace CEF.WebUI
    ...
    Partial Class rvwExpFlujoProyectado
        Inherits PageBase
...
#End Region
        ...
        Private Const ccID_WEBUI_MNT As String = "Flujo Proyectado"
                    ...
                    If Not obeMetodizado Is Nothing Then
                        ...
                        If Not obePeriodoAnterior Is Nothing Then
                            ...
                            If Not obePeriodo Is Nothing Then
                                ...
                                cargarFlujoProyectado(intCodSupuesto)

                                Dim strTitulo As String = "Flujo Proyectado"
        ...
        Private Sub cargarFlujoProyectado(ByVal pintCodSupuesto As Integer)
            ...
            Next
            dsSupuestoProyectado = obrSupuesto.filtrarFlujoProyectado(pintCodSupuesto)
            ...
            dgrdMnt.DataKeyField = "CodCuentaAnalisis"
