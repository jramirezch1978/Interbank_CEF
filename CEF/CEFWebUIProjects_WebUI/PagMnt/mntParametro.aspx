...
<%@ Page Language="vb" AutoEventWireup="false" Codebehind="mntParametro.aspx.vb" Inherits="CEF.WebUI.mntParametro"%>
										...
										<TABLE height="29" cellSpacing="0" cellPadding="0" width="100%" border="0">
											<TR>
												<TD class="lightbluebg" style="PADDING-RIGHT: 5px; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; HEIGHT: 29px"
													noWrap><SPAN class="SearchResultsHeader">Parametros</SPAN></TD>
												<TD width="99%">&nbsp;</TD>
										...
										<TABLE class="Criterio" cellSpacing="1" cellPadding="0" width="600" align="center" border="0">
											...
											<TR>
												<TD class="Marco" vAlign="top" width="600" colSpan="4">
													<DIV class="Grid" id="divComercialProp" style="WIDTH: 600px; HEIGHT: 350px"><asp:datagrid id="dgrdMnt" runat="server" Width="940px" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="False"
															...
															<Columns>
																...
																<asp:TemplateColumn HeaderText="C&#243;digo">
																	...
																	<ItemTemplate>
																		<%# DataBinder.Eval(Container.DataItem,"CodParametro") %>
																	</ItemTemplate>
																	<EditItemTemplate>
																		<asp:TextBox id="txtCodParam" runat="server" Width="100%" Text='<%# DataBinder.Eval(Container.DataItem,"CodParametro") %>' MaxLength="20">
																		</asp:TextBox>
																		<asp:RequiredFieldValidator id="vreqCodParam" runat="server" ErrorMessage="Ingrese el código del parametro"
																			ControlToValidate="txtCodParam" Display="Dynamic">*</asp:RequiredFieldValidator>
																	</EditItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="Descripci&#243;n">
																	...
																	<EditItemTemplate>
																		<asp:TextBox id="txtDescripcion" runat="server" Width="99%" MaxLength="70" Text='<%# DataBinder.Eval(Container.DataItem,"Descripcion") %>'>
																		</asp:TextBox>
																...
																<asp:TemplateColumn HeaderText="Valor1">
																	<HeaderStyle Width="150px"></HeaderStyle>
																	<ItemTemplate>
																		<%# DataBinder.Eval(Container.DataItem,"Valor1") %>
																	</ItemTemplate>
																	<EditItemTemplate>
																		<asp:TextBox id="txtValor1" runat="server" Width="100%" MaxLength="100" Text='<%# DataBinder.Eval(Container.DataItem,"Valor1") %>'>
																		</asp:TextBox>
																		<asp:RequiredFieldValidator id="vreqValor1" runat="server" Display="Dynamic" ControlToValidate="txtValor1" ErrorMessage="Debe ingresar el 1er valor">*</asp:RequiredFieldValidator>
																	</EditItemTemplate>
																</asp:TemplateColumn>
																<asp:TemplateColumn HeaderText="Valor2">
																	<HeaderStyle Width="150px"></HeaderStyle>
																	<ItemTemplate>
																		<%# DataBinder.Eval(Container.DataItem,"Valor2") %>
																	</ItemTemplate>
																	<EditItemTemplate>
																		<asp:TextBox id="txtValor2" runat="server" Width="100%" MaxLength="100" Text='<%# DataBinder.Eval(Container.DataItem,"Valor2") %>'>
																		</asp:TextBox>
																	</EditItemTemplate>
																</asp:TemplateColumn>
