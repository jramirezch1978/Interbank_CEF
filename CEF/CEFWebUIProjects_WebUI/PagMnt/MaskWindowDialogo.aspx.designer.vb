...
Namespace CEF.WebUI
    ...
    '''<summary>
    '''Clase MaskWindowDialogo.
    '''</summary>
    '''<remarks>
    '''Clase generada automáticamente.
    '''</remarks>
    Partial Public Class MaskWindowDialogo
        ...
        '''<summary>
        '''Control ifrMaskVtnDlg.
        '''</summary>
        '''<remarks>
        '''Campo generado automáticamente.
        '''Para modificar, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
        '''</remarks>
        Protected WithEvents ifrMaskVtnDlg As Global.System.Web.UI.HtmlControls.HtmlGenericControl
    End Class
End Namespace
